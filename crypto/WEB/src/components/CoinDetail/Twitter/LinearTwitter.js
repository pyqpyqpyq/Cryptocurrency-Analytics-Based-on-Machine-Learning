...
import DataInfo from '../../../JSON/LinearTwitter.json';
import Card from 'react-bootstrap/Card'


export const LinearTwitter = () => (
  <div>
  {
    <Plot
      data={DataInfo.data}
    ...
    <a class="dropdown-item" href="/model/Linear">Twitter</a>
    <a class="dropdown-item" href="/model/Linear/LinearGov">Goverment</a>
