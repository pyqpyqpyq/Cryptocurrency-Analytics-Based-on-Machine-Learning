...
import DataInfo from '../../../JSON/SVMTwitter.json';
import Card from 'react-bootstrap/Card'


export const SVMTwitter = () => (
  <div>
  {
    <Plot
      data={DataInfo.data}
    ...
    <a class="dropdown-item" href="/model/SVM">Twitter</a>
    <a class="dropdown-item" href="/model/SVM/SVMGov">Goverment</a>
